        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold">
                  Tender<span className="text-indigo-400">Flow</span>
                </span>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors p-2 bg-gray-800 rounded-lg hover:bg-gray-700">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/tender-application" className="text-gray-400 hover:text-indigo-400 transition-colors flex items-center space-x-2">
              ...
              <li>
                <Link to="/po-application" className="text-gray-400 hover:text-indigo-400 transition-colors flex items-center space-x-2">
                  <svg className="w-4 h-4 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors flex items-center space-x-2">
                  <svg className="w-4 h-4 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/dashboard" className="text-gray-400 hover:text-indigo-400 transition-colors flex items-center space-x-2">
                  <svg className="w-4 h-4 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
