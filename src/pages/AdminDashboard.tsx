            ...
            <div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Manage all Tender Plus applications and users</p>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-3">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Real-time application management insights</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white overflow-hidden relative">
              ...
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
                <div>
                  <CardTitle className="text-sm font-medium text-blue-100 mb-1">Total Applications</CardTitle>
                  <div className="text-4xl font-bold text-white mb-1">{applications.length}</div>
                </div>
              ...
              <CardContent className="relative z-10">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-blue-100 text-sm">+{Math.floor(applications.length * 0.15)} this week</span>
                  </div>
                  <div className="text-right">
                    <p className="text-xs text-blue-200">Growth Rate</p>
                    <p className="text-sm font-semibold text-green-300">+18%</p>
                  </div>
                </div>
              </CardContent>
            </Card>

            <Card className="border-0 shadow-xl bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 text-white overflow-hidden relative">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-16 translate-x-16"></div>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
                <div>
                  <CardTitle className="text-sm font-medium text-amber-100 mb-1">Pending Review</CardTitle>
                  <div className="text-4xl font-bold text-white mb-1">{applications.filter(app => app.status === "Under Review").length}</div>
                </div>
                <div className="p-3 bg-white/20 rounded-xl backdrop-blur-sm">
                  <Timer className="h-7 w-7 text-white animate-spin" style={{ animationDuration: '3s' }} />
                </div>
              </CardHeader>
              <CardContent className="relative z-10">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-amber-100 text-sm">Requires attention</span>
                  </div>
                  <div className="text-right">
                    <p className="text-xs text-amber-200">Avg. Time</p>
                    <p className="text-sm font-semibold text-white">2.3 days</p>
                  </div>
                </div>
              </CardContent>
            </Card>

            <Card className="border-0 shadow-xl bg-gradient-to-br from-green-500 via-emerald-500 to-teal-600 text-white overflow-hidden relative">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-16 translate-x-16"></div>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
                <div>
                  <CardTitle className="text-sm font-medium text-green-100 mb-1">Approval Rate</CardTitle>
              ...
              <CardContent className="relative z-10">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-green-100 text-sm">Above target (80%)</span>
                  </div>
                  <div className="text-right">
                    <p className="text-xs text-green-200">Quality Score</p>
                    <p className="text-sm font-semibold text-yellow-300">Excellent</p>
                  </div>
                </div>
              </CardContent>
            </Card>

            <Card className="border-0 shadow-xl bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-700 text-white overflow-hidden relative">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-16 translate-x-16"></div>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3 relative z-10">
                <div>
                  <CardTitle className="text-sm font-medium text-purple-100 mb-1">Total Value</CardTitle>
                  <div className="text-4xl font-bold text-white mb-1">
              ...
              <CardContent className="relative z-10">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-purple-100 text-sm">Total requested</span>
                  </div>
                  <div className="text-right">
                    <p className="text-xs text-purple-200">Disbursed</p>
                    <p className="text-sm font-semibold text-blue-300">
                      KSH {(applications
                        .filter(app => app.status === "Disbursed")
                        .reduce((sum, app) => sum + parseFloat(app.amount.replace(/[^\d.]/g, '')), 0) / 1000000).toFixed(1)}M
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="text-center mb-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Application Categories</h3>
              <p className="text-gray-600">Breakdown by financing type</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="relative group">
                <Card className="border-0 shadow-lg bg-gradient-to-br from-emerald-400 via-emerald-500 to-teal-600 text-white overflow-hidden transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl">
                  ...
                  <CardHeader className="relative z-10 pb-4">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-emerald-100 text-sm">Applications</p>
                      </div>
                    </div>
                    <CardTitle className="text-lg font-bold text-white mb-2">Tender Support</CardTitle>
                    <p className="text-emerald-100 text-sm">SME tender financing solutions</p>
                  </CardHeader>
                  <CardContent className="relative z-10">
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-xl font-bold text-white">
                          KSH {(applications
                            ...
                            .reduce((total, app) => total + parseFloat(app.amount.replace(/[^\d.]/g, '')), 0) / 1000000).toFixed(1)}M
                        </span>
                      </div>
                      <div className="w-full bg-white/20 rounded-full h-2">
                        <div 
                          ...
                          style={{ 
                            width: `${(applications.filter(app => app.type === "Tender Support").length / applications.length) * 100}%` 
                          }}
                        ></div>
                      </div>
                      <div className="flex justify-between text-xs text-emerald-100">
                        <span>
                          {applications.filter(app => app.type === "Tender Support" && (app.status === "Approved" || app.status === "Disbursed")).length} Approved
                        </span>
                        <span>
                          {Math.round((applications.filter(app => app.type === "Tender Support").length / applications.length) * 100)}% of total
                        </span>
                      </div>
                    </div>
                  </CardContent>
              ...
              <div className="relative group">
                <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-400 via-blue-500 to-indigo-600 text-white overflow-hidden transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl">
                  <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent"></div>
                  <CardHeader className="relative z-10 pb-4">
                    <div className="flex items-center justify-between mb-4">
                      <div className="p-3 bg-white/20 rounded-xl backdrop-blur-sm">
                    ...
                    <CardTitle className="text-lg font-bold text-white mb-2">PO Support</CardTitle>
                    <p className="text-blue-100 text-sm">Purchase order financing</p>
                  </CardHeader>
                  <CardContent className="relative z-10">
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                      ...
                      <div className="w-full bg-white/20 rounded-full h-2">
                        <div 
                          className="bg-white h-2 rounded-full transition-all duration-1000" 
                          style={{ 
                            width: `${(applications.filter(app => app.type === "PO Support").length / applications.length) * 100}%` 
                          }}
                        ></div>
                      </div>
                      <div className="flex justify-between text-xs text-blue-100">
                        <span>
                          {applications.filter(app => app.type === "PO Support" && (app.status === "Approved" || app.status === "Disbursed")).length} Approved
                        </span>
                        <span>
                          {Math.round((applications.filter(app => app.type === "PO Support").length / applications.length) * 100)}% of total
                        </span>
                      </div>
                    </div>
                  </CardContent>
              ...
              <div className="relative group">
                <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-400 via-purple-500 to-pink-600 text-white overflow-hidden transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl">
                  <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent"></div>
                  <CardHeader className="relative z-10 pb-4">
                    <div className="flex items-center justify-between mb-4">
                      <div className="p-3 bg-white/20 rounded-xl backdrop-blur-sm">
                    ...
                    <CardTitle className="text-lg font-bold text-white mb-2">Source & Supply</CardTitle>
                    <p className="text-purple-100 text-sm">Procurement financing</p>
                  </CardHeader>
                  <CardContent className="relative z-10">
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-purple-100 text-sm">Total Value</span>
                        <span className="text-xl font-bold text-white">
                          KSH {(applications
                      ...
                      <div className="w-full bg-white/20 rounded-full h-2">
                        <div 
                          className="bg-white h-2 rounded-full transition-all duration-1000" 
                          style={{ 
                            width: `${(applications.filter(app => app.type === "Source & Supply").length / applications.length) * 100}%` 
                          }}
                        ></div>
                      </div>
                      <div className="flex justify-between text-xs text-purple-100">
                        <span>
                          {applications.filter(app => app.type === "Source & Supply" && (app.status === "Approved" || app.status === "Disbursed")).length} Approved
                        </span>
                        <span>
                          {Math.round((applications.filter(app => app.type === "Source & Supply").length / applications.length) * 100)}% of total
                        </span>
                      </div>
                    </div>
                  </CardContent>
